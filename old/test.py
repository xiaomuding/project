...
#locate the iframe
#<iframe name="" frameborder="0" id="x-URS-iframe" scrolling="no" style="width: 100%; height: 100%; border: none; background: none;" src="https://dl.reg.163.com/webzj/m163_2/pub/index_dl.html?wdaId=&amp;pkid=CvViHzl&amp;product=mail163"></iframe>
driver.switch_to.frame("x-URS-iframe")
#insert username
#<input data-placeholder="邮箱帐号或手机号" name="email" data-type="email" data-loginname="loginEmail" data-required="true" class="j-inputtext dlemail" type="text" autocomplete="off" tabindex="1" spellcheck="false" id="auto-id-1525853567286" placeholder="邮箱帐号或手机号" style="width: 122px;">
